 ...
 * @article  : https://www.designgurus.io/viewer/document/grokking-the-coding-interview/63ddad0980798b625e14ef14
...
const threeSumSolution1 = (arr, expectedSum) => {
  ...
  for (const triplet of tripletsSet) {
    tripletsArr.push(JSON.parse(triplet));
  }
